...
public class UserDAO {
	...
	private static final String APPROVE_BY_USERNAME = "INSERT INTO Customers (username, accounttype, balance, passcode) "
			+ "SELECT username, accountTypeSelect, 0.00, passcode FROM PendingRegistrations " + "WHERE username = ?;"
	...
	private static final String UPDATE_BALANCE = "UPDATE Customers " + "SET balance = ? " + "WHERE username = ?";
